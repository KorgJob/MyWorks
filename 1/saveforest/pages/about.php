...
<body>
    ...
    <main>
        <section class="first_about_block shadow p-3 my-5 bg-light container">
            <h2 class="text-center my-3">Защита леса - наше всё!</h2>
            <div class="text_about d-flex container my-5 align-items-center">
                <div class="d-flex">
                    <p class="text_about_first mx-4">Мы занимаемся защитой лес на протяжении долго времени, в наше движение пришло уже более 
                    50 000 активистов и каждый из них активно участвует в посадке деревьев, сборки мусора, тушением пожаров
                    и распростронении нашего дела! Мы гордимся этим и призываем вас тоже присоединиться к нам. Даже этим
                    вы уже поможете нам, а если вы посадите дерево, то это будет ещё лучше!</p>
                    <p class="text_about_first mx-4">Мы занимаемся защитой лес на протяжении долго времени, в наше движение пришло уже более 
                    50 000 активистов и каждый из них активно участвует в посадке деревьев, сборки мусора, тушением пожаров
                    и распростронении нашего дела! Мы гордимся этим и призываем вас тоже присоединиться к нам. Даже этим
                    вы уже поможете нам, а если вы посадите дерево, то это будет ещё лучше!</p>
                </div>
                <img class="shadow p-3 mb-5 bg-white rounded" src="../img/valant.jpeg" alt="valanters">
            </div>
        </section>
    </main>
