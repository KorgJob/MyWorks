                    ...
                    <div class="shop_sidebar_area shadow-lg p-3 mb-5 bg-body rounded">
                        ...
                        <div class="catagories-menu mb-50">
                            <ul class="collapse show" id="collapseExample">
                                ...
                                <li><a data-filter="15" href="#">Куртки</li></a>
                                <li><a data-filter="16" href="#">Брюки</li></a>
                                <li><a data-filter="17" href="#">Толстовки</li></a>
                                <li><a data-filter="18" href="#">Футболки</li></a>
                            </ul>
                        </div>
                        <div class="brands mb-50">
                            ...
                            <ul class="collapse show" id="collapseExample5">
                                <li><a href="/pages/gender/woman_brand.php">Все</li></a>
                                <li><a href="/pages/gender/woman_brand.php">NIKE</li></a>
                                <li><a href="/pages/gender/woman_brand.php">TNF</li></a>
                                <li><a href="/pages/gender/woman_brand.php">NB</li></a>
                                <li><a href="/pages/gender/woman_brand.php">PUMA</li></a>
                                <li><a href="/pages/gender/woman_brand.php">FILA</li></a>
                            </ul>
                        </div>
                    </div>
               </div>
                    ...
                    <div class="shop_grid_product_area">
                        <div class="row">
                            ...
                            <?php
                                ...
                                $sql = "SELECT * FROM `goods` WHERE `category` IN (15,16,17,18) AND `count` > 0";
