                    ...
                    <div class="shop_sidebar_area shadow-lg p-3 mb-5 bg-body rounded">
                        ...
                        <div class="catagories-menu mb-50">
                            <ul class="collapse show" id="collapseExample">
                                ...
                                <li><a data-filter="19" href="#">Куртки</li></a>
                                <li><a data-filter="20" href="#">Брюки</li></a>
                                <li><a data-filter="21" href="#">Толстовки</li></a>
                                <li><a data-filter="22" href="#">Футболки</li></a>
                            </ul>
                        </div>
                        <div class="brands mb-50">
                            ...
                            <ul class="collapse show" id="collapseExample5">
                                <li><a href="/pages/gender/children_brand.php">Все</li></a>
                                <li><a href="/pages/gender/children_brand.php">NIKE</li></a>
                                <li><a href="/pages/gender/children_brand.php">TNF</li></a>
                                <li><a href="/pages/gender/children_brand.php">NB</li></a>
                                <li><a href="/pages/gender/children_brand.php">PUMA</li></a>
                                <li><a href="/pages/gender/children_brand.php">FILA</li></a>
                            </ul>
                        </div>
                    </div>
               </div>
                    ...
                    <div class="shop_grid_product_area">
                        <div class="row">
                            ...
                            <?php
                                ...
                                $sql = "SELECT * FROM `goods` WHERE `category` IN (19,20,21,22) AND `count` > 0";
                                $result = mysqli_query($link, $sql); 
                            ?>
                            <?php while ($row = mysqli_fetch_array($result)):?>
                            <div class="col-12 col-sm-6 col-lg-4 mb-5" data-cat="<?=$row['category']?>">
