                    ...
                    <div class="shop_sidebar_area shadow-lg p-3 mb-5 bg-body rounded">
                        ...
                        <div class="catagories-menu mb-50">
                            <ul class="collapse show" id="collapseExample">
                                <li><a href="/pages/gender/woman.php">Все</li></a>
                                <li><a href="/pages/gender/woman.php">Куртки</li></a>
                                <li><a href="/pages/gender/woman.php">Брюки</li></a>
                                <li><a href="/pages/gender/woman.php">Толстовки</li></a>
                                <li><a href="/pages/gender/woman.php">Футболки</li></a>
                            </ul>
                        </div>
