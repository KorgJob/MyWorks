                    ...
                    <div class="shop_sidebar_area shadow-lg p-3 mb-5 bg-body rounded">
                        ...
                        <div class="catagories-menu mb-50">
                            <ul class="collapse show" id="collapseExample">
                                ...
                                <li><a data-filter="23" href="#">Куртки</li></a>
                                <li><a data-filter="24" href="#">Брюки</li></a>
                                <li><a data-filter="25" href="#">Толстовки</li></a>
                                <li><a data-filter="26" href="#">Футболки</li></a>
                            </ul>
                        </div>
                        <div class="brands mb-50">
                            ...
                            <ul class="collapse show" id="collapseExample5">
                                <li><a href="/pages/gender/sale_brand.php">Все</li></a>
                                <li><a href="/pages/gender/sale_brand.php">NIKE</li></a>
                                <li><a href="/pages/gender/sale_brand.php">TNF</li></a>
                                <li><a href="/pages/gender/sale_brand.php">NB</li></a>
                                <li><a href="/pages/gender/sale_brand.php">PUMA</li></a>
                                <li><a href="/pages/gender/sale_brand.php">FILA</li></a>
                            </ul>
                        </div>
                    </div>
               </div>
