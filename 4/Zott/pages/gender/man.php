                    ...
                    <div class="shop_sidebar_area shadow-lg p-3 mb-5 bg-body rounded">
                        ...
                        <div class="catagories-menu mb-50">
                            <ul class="collapse show" id="collapseExample">
                                ...
                                <li><a data-filter="3" href="#">Куртки</li></a>
                                <li><a data-filter="4" href="#">Брюки</li></a>
                                <li><a data-filter="5" href="#">Толстовки</li></a>
                                <li><a data-filter="14" href="#">Футболки</li></a>
                            </ul>
                        </div>
                        <div class="brands mb-50">
                            ...
                            <ul class="collapse show" id="collapseExample5">
                                <li><a href="/pages/gender/man_brand.php">Все</li></a>
                                <li><a href="/pages/gender/man_brand.php">NIKE</li></a>
                                <li><a href="/pages/gender/man_brand.php">TNF</li></a>
                                <li><a href="/pages/gender/man_brand.php">NB</li></a>
                                <li><a href="/pages/gender/man_brand.php">PUMA</li></a>
                                <li><a href="/pages/gender/man_brand.php">FILA</li></a>
                            </ul>
                        </div>
                    </div>
               </div>
                    ...
                    <div class="shop_grid_product_area">
                        <div class="row">
                            ...
                            <?php
                                ...
                                $sql = "SELECT * FROM `goods` WHERE `category` IN (3,4,5,14) AND `count` > 0";
